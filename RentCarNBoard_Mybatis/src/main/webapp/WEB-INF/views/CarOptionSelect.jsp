...
<%
	...
	RentCarDao dao  = null;//new RentCarDAOImpl("RentCar");
	RentCarBDto vo = null;
	try{
...
<body>
	<center>
		<form action="CarReserveResult" method="post">
			<table width="100%">
				<tr height="100">
					<td align="center" colspan="3"><font size="6" color="gray">[<%=vo.getName()%>
					
								옵션선택]</font></td>
				</tr>
				<tr>
					<td rowspan="7" width="50%" align="center"><image alt=""
							src="resources/img/<%=img%>" width="450"></image></td>
