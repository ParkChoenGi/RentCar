<%@page import="com.pcg.spring.common.PageManager"%>
...
<body>
	<%
		...
		try {
			...
			if (category == 0) {
				response.sendRedirect("CarReserveMain");
			}
		...
		<table>
			...
			%><tr height="220">
				...
				<td width="33%" align="center"><a
					href="CarReserveInfo?no=<%=vo.getNo()%>&fromPage=CarCategoryList&category=<%=category%>">
						<img alt="" src="resources/img/<%=vo.getImg()%>" width="300" height="200">
				</a>
					<p>
						<font size="3" color="gray"><b>차량명 : <%=vo.getName()%></b></font></td>
				<%
