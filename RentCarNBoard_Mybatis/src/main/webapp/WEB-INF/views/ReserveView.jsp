<%@page import="com.pcg.spring.dto.ReserveView"%>
...
<body>
	...
	<center>
		<font size="5" color="gray"><%=memid%>님 예약리스트(<%=list.size()%>건)</font>
		<table class="table table-striped">
			...
			<tr>
				...
				%>
				<td><button
						onclick="location.href='Adjust?regno=<%=regno%>&img=<%=img%>'">수정</button>
				</td>
				<td><button
						onclick="location.href='Delete?regno=<%=regno%> '">예취</button></td>
			</tr>
			<%
				}
			%>
